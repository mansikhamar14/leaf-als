"""
MFCC Baseline for ALS Detection
...
class MFCC_ALS_Model(nn.Module):
    """End-to-end: raw waveform -> MFCC -> CNN -> ALS/Healthy."""
    ...
    def forward(self, waveform):
        # waveform: [B, 1, T]
        features = self.mfcc_transform(waveform) # [B, 1, n_filters, time]
        features = features.squeeze(1)           # [B, n_filters, time]
...
def main():
    ...
    print("\nModel saved to mfcc_als_best.pth")
